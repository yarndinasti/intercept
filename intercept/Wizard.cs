    ...
    private void Wizard_Load(object sender, EventArgs e)
    {
      ...
      using (RegistryKey list64App = Registry.LocalMachine.OpenSubKey(path64Key))
      {
        ...
        foreach (String app in apps)
        {
          ...
          if (displayName != null && Config.codeEditor.Any(displayName.Contains))
      ...
      AHKcombo.SelectedIndex = 0;

      if (InterceptionInstalled.Checked && !File.Exists(programData + "settings.json"))
      {
        HIDbtn.Enabled = true;
        HIDtxt.Enabled = true;
        CodeCmb.Enabled = true;
        AHKcombo.Enabled = true;
      }
